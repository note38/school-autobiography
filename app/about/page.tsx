...
export default function AboutPage() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">Learn more about our medical facility and staff.</p>
        ...
        {researchers.map((researcher, index) => (
          <Card key={index}>
            ...
            <CardContent className="flex items-center space-x-4">
              <Image src={researcher.picture} alt={researcher.name} width={100} height={100} className="rounded-full" />
              <div>
                <p><strong>Contact:</strong> {researcher.contact}</p>
